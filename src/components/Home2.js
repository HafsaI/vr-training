      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 d-flex align-items-stretch">
            <div className="card" style={{backgroundImage: {pic}}} data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div className="card" style={{backgroundImage: {pic}}}data-aos="fade-up" data-aos-delay="200">
              <div className="card-body">
